...
root = Tk()
root.title("фазенда")
root.geometry("1300x620+5+5")#1300x460+200+2
root['bg'] = 'orange'
...
notebook.add(frame6, text="<КАЛЬКУЛЯТОР_4>", compound=LEFT)
notebook.add(frame7, text="<КАЛЬКУЛЯТОР_5>", compound=LEFT)
...
kalkulators(frame3, sum_sp3)
kalkulators(frame4, sum_sp4)
kalkulators(frame5, sum_sp5)
kalkulators(frame6, sum_sp6)
kalkulators(frame7, sum_sp7)
