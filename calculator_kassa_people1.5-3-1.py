...
def total_buyers():
    ...
    def diagra():
        ...
        mon0 = []
        st = 1
        color = ['Indigo', 'LimeGreen', 'DarkRed', 'SaddleBrown', 'green', 'orange', 'red', 'blue', 'purple', 'gold', 'black', 'MediumVioletRed']
        def setka(total, mesj):
            ...
            for i in range(32):  # ось х с числами месяца
                ...
                canv.create_line(55 + i * 30 + n, 663-m, 55 + i * 30 + n, 100 - m, width=1, tags='del') 
            for i in range(k // 10 + 1):  # ось у с килограммами
                ...
                canv.create_line(50 + n, 665 - st * i * 10 - m, 1030 + n, 665 - st * i * 10 - m, width=1, tags='del') 
        def diagr(mesj, cvet):
            global nadpisi, total, t, st, li
            kg1 = []
            num1 = []
            print('month = ', mesj)
                    ...
                    for j in range(len(kg1)):  # точки графика число и кг.
                        ...
                        if j > 0:
                            canv.create_line(50 + num1[j - 1] * 30 + 5 + n, 660 - st * kg1[j - 1] + 5 - m,
                                             50 + num1[j] * 30 + 5 + n, 660 - st * kg1[j] + 5 - m, width=3, fill=cvet,
                   tags='del')
